...
from DiffPure.score_sde.losses import get_optimizer
from DiffPure.score_sde.models import utils as mutils
from DiffPure.score_sde.models.ema import ExponentialMovingAverage
from DiffPure.score_sde import sde_lib
...
class RevGuidedDiffusion(torch.nn.Module):
    def __init__(self, args, config, device=None):
        ...
        if config.data.dataset == 'ImageNet':
            ...
            img_shape = (3, 32, 32)
            model_dir = './DiffPure/pretrained/score_sde'
    ...
    def image_editing_sample(self, img, bs_id=0, tag=None):
        ...
        out_dir = os.path.join(self.args.savepath, 'imgs', 'bs' + str(bs_id) + '_' + tag)
